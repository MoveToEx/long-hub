...
Note that when entering tags, the text being entered does not count as a tag. You have to press enter or select a tag from the dropdown menu to "actually" enter a tag.  

The rating component used in Aggressiveness can be set to empty (0) by clicking the already selected value again.  



## After uploading

Due to caching policy used in optimization, it may take up to 2 minutes for data cache to stale. So please be patient if you cannot see your image right away.  
