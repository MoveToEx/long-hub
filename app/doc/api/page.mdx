...
<Accordion>
    <AccordionSummary expandIcon={ <ExpandMoreIcon /> }>
        <code>GET /api/post/</code> - Get posts
    </AccordionSummary>
...
<Accordion>
    <AccordionSummary expandIcon={ <ExpandMoreIcon /> }>
        <code>GET /api/post/search/[selector]</code> - Search for posts that matches a selector
    </AccordionSummary>

    <AccordionDetails>
        Method: `GET`  
        URL: `/api/post/search/[selector]`, selector=an uri-encoded base64 string of a stringified JSON object, possibly with the following fields:  
...
<Accordion>
    <AccordionSummary expandIcon={ <ExpandMoreIcon /> }>
        <code>GET /api/post/tag/[TAG]/</code> - Search for posts tagged with TAG
    </AccordionSummary>

    <AccordionDetails>
        Method: `GET`  
        URL: `/api/post/tag/[tag]`, tag=Tag name to search for  
        Params: None
    </AccordionDetails>
</Accordion>
...
<Accordion>
    <AccordionSummary expandIcon={ <ExpandMoreIcon /> }>
        <code>POST /api/post/</code> - Upload an empty post
    </AccordionSummary>
    ...
    <AccordionDetails>
        ...
        To create a post, combine this endpoint with <code>PUT /api/post/[id]</code>
    </AccordionDetails>
</Accordion>

<Accordion>
    <AccordionSummary expandIcon={ <ExpandMoreIcon /> }>
        <code>PUT /api/post/[id]/</code> - Modify a post
    </AccordionSummary>

    <AccordionDetails>
        Method: `PUT`  
        URL: `/api/post/[id]/`, id=ID of the post to be modified  
...
<Accordion>
    <AccordionSummary expandIcon={ <ExpandMoreIcon /> }>
        <code>POST /api/similar/</code> - Search for posts with perceptually similar images
    </AccordionSummary>
